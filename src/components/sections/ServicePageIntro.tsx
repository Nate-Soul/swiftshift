  ...
  return (
    <section className="py-16">
        <div className="container relative">
            <div className="-mt-[30%] md:-mt-[15%] bg-white text-dark-500 w-full rounded-[0.625rem] border p-4 grid grid-cols-2 gap-6 md:gap-0">
                <div className="col-span-full md:col-span-1 px-8 pb-8 md:pb-0 border-b md:border-r md:border-b-0">
                    <h2 className="text-xl font-black flex items-center gap-x-3 mb-4 before:w-1 before:h-10 before:bg-primary-500">
