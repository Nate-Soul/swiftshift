...
import BuySiteForm from "../subcomponents/BuySiteForm";
  ...
  return (
    ...
    <section className="py-16 min-h-[500px]">
        <div className="container">
            <SectionHeading 
                title="Think globally. work locally" 
    ...
    <div id="acquirePlatform" className="bg-light-300 bg-opacity-20 py-14">
        <div className="container relative flex gap-8 md:gap-12 lg:gap-14 flex-wrap md:flex-nowrap">
            ...
            <div className="basis-full md:basis-3/5">
                <BuySiteForm title="Interested in acquiring our platform?"/>
            </div>
        </div>
    </div>
    </>
